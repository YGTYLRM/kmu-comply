...
from agent.actions import _compute_scores, _weighted_score
...
applicable_regulations = [
    ...
    RegulationApplicability(regulation=Regulation.MILOG,   applies=True,  reason="MiLoG gilt für alle Arbeitgeber: 75 Mitarbeiter. Gesetzlicher Mindestlohn (13,90 Euro/Stunde, ab 1. Januar 2026) vorgeschrieben."),
...
regulation_scores = _compute_scores(applicable_regulations, gap_analysis)
