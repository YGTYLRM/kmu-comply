...
const PLAN_LABELS: Record<string, { name: string; price: string; features: string[] }> = {
  starter: {
    name: "Starter",
    price: "€49/month",
    features: ["1 company profile", "Monthly re-assessments", "All 11 regulations", "Email alerts"],
  },
  professional: {
    name: "Professional",
    price: "€149/month",
    features: ["3 company profiles", "Weekly re-assessments", "All 11 regulations", "Priority email alerts", "Score trend history"],
  },
  enterprise: {
    name: "Enterprise",
    price: "Custom",
    features: ["Unlimited companies", "Custom schedule", "All 11 regulations", "Dedicated support"],
  },
};
    ...
    <main className="bg-dark-950 min-h-screen pt-28 pb-16 px-4 sm:px-6">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">Billing & plan</h1>
        </div>

        {!data?.stripe_enabled && (
          <div className="rounded-2xl border border-white/[0.07] bg-dark-900/60 p-8 text-center">
            <p className="text-slate-500 text-sm mb-2">Billing is not yet active.</p>
            <p className="text-xs text-slate-600">Contact us to set up your subscription.</p>
        ...
        {data?.stripe_enabled && !sub && (
          ...
          >
            ...
            <h2 className="text-lg font-bold text-white mb-2">No active subscription</h2>
            <p className="text-sm text-slate-500 mb-6">Choose a plan to start monitoring your compliance.</p>
          ...
          >
              ...
              <div className="flex items-start justify-between gap-4 mb-5">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <h2 className="text-lg font-bold text-white">{plan?.name ?? sub.plan} plan</h2>
            ...
            {sub.plan === "starter" && (
              <div className="rounded-2xl border border-brand-500/20 bg-brand-500/[0.04] p-5 flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold text-white">Need more companies?</p>
                  <p className="text-xs text-slate-500 mt-0.5">Professional gives you 3 profiles and weekly screenings.</p>
                </div>
